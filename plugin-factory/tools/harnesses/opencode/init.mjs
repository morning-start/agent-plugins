/**
 * opencode/init.mjs — opencode 初始化。
 */
import { mkdir, readFile, readdir, stat, writeFile } from "node:fs/promises";
import { dirname, join, relative } from "node:path";

const TEMPLATES_ROOT = join(import.meta.dirname, "..", "..", "..", "templates", "harnesses", "opencode");
...
/**
 * 生成 opencode.json 配置。
 * @param {object} options - { plugins: string[] }
 * @returns {object} opencode.json 结构
 */
export function generateConfig({ plugins = [] } = {}) {
