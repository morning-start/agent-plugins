...
export const HARNESSES = ["claude-code", "pi", "opencode", "oh-my-pi", "codex"];
...
function buildValues({ name, prefix, description, userLang, harnesses, validationScripts }) {
  ...
  if (harnesses.includes("codex")) shLines.push('echo "  codex:       copy to ~/.agents/plugins/ (see .codex-plugin/plugin.json)"');
  ...
  if (harnesses.includes("codex")) psLines.push('Write-Host "  codex:       copy to ~/.agents/plugins/ (see .codex-plugin/plugin.json)"');
